...
application::application()
{
    ...
    glfwSetMouseButtonCallback(window_, [](GLFWwindow *window, int btn, int act, int mods) {
        static_cast<application *>(glfwGetWindowUserPointer(window))->mouseButtonCallback(window, btn, act, mods);
    });
    glfwSetScrollCallback(window_, [](GLFWwindow *window, double xoffset, double yoffset) {
        static_cast<application *>(glfwGetWindowUserPointer(window))->mousePositionCallback(window, xoffset, yoffset);
    });
